...
const sampleMarkup = `<p><br></p><img src="http://jay.aliyuntao.top/11.jpg"/><p>123123<img src="http://jay.aliyuntao.top/11.jpg"/>123</p>`;
...
export default class MediaEditorExample extends React.Component {
  constructor(props) {
    ...
    this.logState = () => {
      ...
      //   console.log(convertFromHTML(stateToHTML(content)))
      //   const blocksFromHTML = convertFromHTML(stateToHTML(content));
      //   const state = ContentState.createFromBlockArray(
      //     blocksFromHTML.contentBlocks,
      //     blocksFromHTML.entityMap
      //   );
